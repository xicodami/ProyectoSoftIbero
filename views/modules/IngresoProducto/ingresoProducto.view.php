<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Registrar Ingreso Producto</h1><br>
            <a type="submit" href="?c=Inventarios&a=Inventario" class="btn bg-secondary text-dark">Atrás</a>
            <a type="submit" href="?c=IngresoProductos&a=consultarIngresoProductoContr&param=2" class="btn bg-primary text-white">Lista de Ingresos de Productos</a>
            <hr>
            <div class="row">
                    ...
                    <div class="card-group">
                        <div class="card">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Escriba la cantidad" name="cantidad_producto" title="Por favor ingrese solo letras y números se aceptan con caracteres especiales" required style="text-transform: uppercase;">
                            </div>&nbsp;
                            <div class="form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="centrar">
                                <input class="btn btn-success" type="submit" value="Registrar Ingreso Producto">&nbsp;
                            </div>
                        </div>
                    </div>
                </form>
